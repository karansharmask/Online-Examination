...
public partial class crtViewStudentInformation : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            String reportPath = Server.MapPath("crtViewStudentInformation.rpt");
            customRpt.Load(reportPath);

            SqlDataAdapter SqlDA = new SqlDataAdapter(Session["Print"].ToString(), conn);

            DataSet ds = new DataSet();
            SqlDA.Fill(ds, "viewStudent_Information");
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter SqlDA = new SqlDataAdapter("SELECT * FROM viewStudent_Information WHERE Student_First_Name LIKE '" + ddlStudentName.SelectedValue + "%'", conn);

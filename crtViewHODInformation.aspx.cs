...
public partial class crtViewHODInformation : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter SqlDA = new SqlDataAdapter("SELECT * FROM viewHOD_Information WHERE Department_Name LIKE '" + ddlDepartmentName.SelectedValue + "%'", conn);
